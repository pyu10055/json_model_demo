...
(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     * before the load is completed.
     */
    function loadFrozenModel(modelUrl, requestOption, onProgress) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        model = new FrozenModel(modelUrl, requestOption, null, onProgress);
    ...
    function loadTfHubModule(tfhubModuleUrl, requestOption, onProgress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, loadFrozenModel("" + tfhubModuleUrl + DEFAULT_MODEL_NAME + TFHUB_SEARCH_PARAM, requestOption, onProgress)];
            });
        });
    }
